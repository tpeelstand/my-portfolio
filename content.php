<div class="container main-content">
    <div class="row">
        <section class="col-xs-12 col-md-8">
            ...
            <div class="contract-work">
                <div class="job">
                    <p><span class="jobTitle">YesMail -  Front-end developer</span><a class="web-link" href="http://creative-cow-design.com/marriott-landing-page" target="_blank"><i class="fa fa-desktop"></i> Visit Site</a><br> 
            ...
            <div class="contract-work">
                <div class="job">
                    <p><span class="jobTitle">Journey Mental Health - Front-end developer/Data Entry</span><br> 
        ...
        <section class="col-xs-12 col-md-4 skills">
            <div class="github">
                <h4>GitHub Code</h4>
                <ul>
            ...
            <div class="indent">
                ...
                <h4>General Computer Knowledge</h4>
                <ul>
                    ...
                    <li>BaseCamp</li>
                    <li>Video Conferencing - Skype, WebEx & Google Hangouts</li>
                    <li>Dropbox/WeTransfer</li>
                </ul>
            </div>
            <div class="social">
                <h3><a name="connect"></a>Let's connect!</h3><a href="https://www.linkedin.com/pub/nathan-ellingson/22/7b3/236" target="_blank"><img src="images/linkedin-button.png" alt="Connect with me on Linkedin"></a>
                <ul> 
                    <li><a href="mailto: n_ellingson1@yahoo.com"><i class="fa fa-envelope-o"></i> n_ellingson1@yahoo.com</a></li>
                    <li><i class="fa fa-phone"></i> 262-366-7112</li>
                </ul>
            </div>
        </section>
    </div>
